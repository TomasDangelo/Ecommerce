...
const CentralSection = () => {
  ...
  return (
    <Box id="central-section"
      ...
      <Typography variant="" sx={{ fontWeight: 'bold', textWrap: 'nowrap', fontSize: { xl: '4rem', md: '3rem', xs: '2rem' },  textShadow: '2px 2px 4px rgba(0,0,0,0.3)', letterSpacing: '1px', marginBottom: '0rem'  }}>  
            Ruth Pastelería
          </Typography>
          <Typography
